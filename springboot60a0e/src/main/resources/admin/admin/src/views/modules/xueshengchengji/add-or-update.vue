<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主观题成绩" prop="zhuguantichengji">
          <el-input v-model="ruleForm.zhuguantichengji" 
              placeholder="主观题成绩" clearable  :readonly="ro.zhuguantichengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主观题成绩" prop="zhuguantichengji">
              <el-input v-model="ruleForm.zhuguantichengji" 
                placeholder="主观题成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客观题成绩" prop="keguantichengji">
          <el-input v-model="ruleForm.keguantichengji" 
              placeholder="客观题成绩" clearable  :readonly="ro.keguantichengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="客观题成绩" prop="keguantichengji">
              <el-input v-model="ruleForm.keguantichengji" 
                placeholder="客观题成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="成绩总分" prop="chengjizongfen">
            <el-input v-model="chengjizongfen"
                placeholder="成绩总分" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chengjizongfen" label="成绩总分" prop="chengjizongfen">
              <el-input v-model="ruleForm.chengjizongfen" 
                placeholder="成绩总分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="成绩等级" prop="chengjidengji">
        ...
        <div v-else>
          <el-form-item class="input" label="成绩等级" prop="chengjidengji">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="成绩评语" prop="chengjipingyu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="成绩评语"
                  v-model="ruleForm.chengjipingyu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chengjipingyu" label="成绩评语" prop="chengjipingyu">
                    <span>{{ruleForm.chengjipingyu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	zuoyetupian : false,
	zhuguantichengji : false,
	keguantichengji : false,
	chengjizongfen : false,
	chengjidengji : false,
	chengjipingyu : false,
	xuehao : false,
	...
	jiaoshixingming : false,
      ...
      rules: {
          ...
          zhuguantichengji: [
                { required: true, message: '主观题成绩不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          keguantichengji: [
                { required: true, message: '客观题成绩不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          chengjizongfen: [
                { validator: validateIntNumber, trigger: 'blur' },
          ...
          chengjidengji: [
                { required: true, message: '成绩等级不能为空', trigger: 'blur' },
          ],
          chengjipingyu: [
                { required: true, message: '成绩评语不能为空', trigger: 'blur' },
          ],
          xuehao: [
          ],
          xueshengxingming: [
  ...
  computed: {
    chengjizongfen: {
      get: function () {
        return 0+parseFloat(this.ruleForm.zhuguantichengji==""?0:this.ruleForm.zhuguantichengji)+parseFloat(this.ruleForm.keguantichengji==""?0:this.ruleForm.keguantichengji) || 0
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zuoyetupian = true;
          ...
          if(o=='zhuguantichengji'){
            this.ruleForm.zhuguantichengji = obj[o];
	    this.ro.zhuguantichengji = true;
            continue;
          }
          if(o=='keguantichengji'){
            this.ruleForm.keguantichengji = obj[o];
	    this.ro.keguantichengji = true;
            continue;
          }
          if(o=='chengjizongfen'){
            this.ruleForm.chengjizongfen = obj[o];
	    this.ro.chengjizongfen = true;
            continue;
          }
          if(o=='chengjidengji'){
	    ...
	    this.ro.chengjidengji = true;
          ...
          if(o=='chengjipingyu'){
            this.ruleForm.chengjipingyu = obj[o];
	    this.ro.chengjipingyu = true;
            continue;
          }
          if(o=='xuehao'){
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.chengjizongfen = this.chengjizongfen
      // ${column.compare}
      // ${column.compare}
      // ${column.compare}
      // ${column.compare}
