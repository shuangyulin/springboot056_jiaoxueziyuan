<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课程章节" prop="kechengzhangjie">
          <el-input v-model="ruleForm.kechengzhangjie" 
              placeholder="课程章节" clearable  :readonly="ro.kechengzhangjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程章节" prop="kechengzhangjie">
              <el-input v-model="ruleForm.kechengzhangjie" 
                placeholder="课程章节" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="学生作业" prop="xueshengzuoye">
          <file-upload
          tip="点击上传学生作业"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.xueshengzuoye?ruleForm.xueshengzuoye:''"
          @change="xueshengzuoyeUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.xueshengzuoye" label="学生作业" prop="xueshengzuoye">
            <el-button type="text" size="small" @click="download(ruleForm.xueshengzuoye)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="提交内容" prop="tijiaoneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tijiaoneirong" label="提交内容" prop="tijiaoneirong">
                    <span v-html="ruleForm.tijiaoneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          kechengzhangjie: [
                { required: true, message: '课程章节不能为空', trigger: 'blur' },
          ],
          zuoyetupian: [
          ],
          zuoyeyaoqiu: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zuoyemingcheng = true;
          ...
          if(o=='kechengzhangjie'){
            this.ruleForm.kechengzhangjie = obj[o];
	    this.ro.kechengzhangjie = true;
            continue;
          }
          if(o=='zuoyetupian'){
	    ...
	    this.ro.zuoyeyaoqiu = true;
          ...
          if(o=='xueshengzuoye'){
            this.ruleForm.xueshengzuoye = obj[o];
	    this.ro.xueshengzuoye = true;
            continue;
          }
          if(o=='tijiaoriqi'){
	...
	this.ruleForm.tijiaoneirong = this.ruleForm.tijiaoneirong.replace(reg,'../../../springboot60a0e/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    xueshengzuoyeUploadChange(fileUrls) {
	this.ruleForm.xueshengzuoye = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
